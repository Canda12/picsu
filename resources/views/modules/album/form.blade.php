        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white p-5 rounded-lg shadow">
                <div class="mb-5">
                    ...
                    <x-input id="nama_album" class="block mt-1 w-full" type="text" name="nama_album" :value="old('nama_album', $album->nama_album ?? '')" placeholder="Masukan nama album foto" required autofocus />
                </div>
                <div class="mb-5"> 
                    <x-label for="deskripsi" :value="__('Deskripsi')" />
                    <x-input id="deskripsi" class="block mt-1 w-full" type="text" name="deskripsi" :value="old('deskripsi', $album->deskripsi ?? '')" placeholder="Masukan deskripsi album" required autofocus />
                </div>
                <div class="mb-5">
