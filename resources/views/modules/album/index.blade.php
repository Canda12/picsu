    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <table class="min-w-full bg-white border-gray-300 w-full">
                    <thead>
                        <tr>
                            <th class="py-2 px-4 border-b">Nama Album</th>
                    ...
                    <tbody>
                        @foreach ($albums as $album)
                            <tr>
                                <td class="py-2 px-4 border-b">{{ $album->nama_album }}</td>
                                <td class="py-2 px-4 border-b">{{ $album->deskripsi }}</td>
                                <td class="py-2 px-4 border-b">{{ $album->tgl_dibuat }}</td>
