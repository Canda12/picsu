        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white p-5 rounded-lg shadow">
                ...
                <div class="mb-3">
                    ...
                    <select name="album_id" id="album_id" class="block mt-1 w-full rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="deskripsi_foto" id="deskripsi_foto" class="block mt-1 w-full rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">{{ $foto->deskripsi_foto ?? '' }}</textarea>
                </div>
                <div class="mb-3">
